...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armv6 --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --nm=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-nm --sysroot=/home/admin_2/android-ndk-r8c/platforms/android-5/arch-arm --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums  -fno-strict-aliasing -finline-limit=300 -marm -march=armv6 ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=/home/admin_2/android-ndk-r8c/platforms/android-5/arch-arm/usr/lib -L/home/admin_2/android-ndk-r8c/platforms/android-5/arch-arm/usr/lib  -nostdlib -lc -lm -ldl -llog' --enable-parsers --disable-encoders --enable-decoders --disable-muxers --enable-demuxers --enable-swscale --disable-ffplay --disable-ffprobe --disable-ffserver --enable-network --enable-indevs --disable-bsfs --disable-filters --enable-protocols --enable-asm
...
SRC_PATH="/home/admin_2/Projects/rockplayer_ffmpeg_git_20100418"
SRC_PATH_BARE=/home/admin_2/Projects/rockplayer_ffmpeg_git_20100418
BUILD_ROOT="/home/admin_2/Projects/rockplayer_ffmpeg_git_20100418"
CC_IDENT=gcc 4.4.3 (GCC)
ARCH=arm
CC=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
AS=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
LD=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCC=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ar
RANLIB=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/home/admin_2/android-ndk-r8c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-strip
CPPFLAGS= --sysroot=/home/admin_2/android-ndk-r8c/platforms/android-5/arch-arm -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -marm -march=armv6  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -marm -march=armv6  -fPIC -g
CC_O=-o $@
LDFLAGS= -Wl,-rpath-link=/home/admin_2/android-ndk-r8c/platforms/android-5/arch-arm/usr/lib -L/home/admin_2/android-ndk-r8c/platforms/android-5/arch-arm/usr/lib -nostdlib -lc -lm -ldl -llog --sysroot=/home/admin_2/android-ndk-r8c/platforms/android-5/arch-arm -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
